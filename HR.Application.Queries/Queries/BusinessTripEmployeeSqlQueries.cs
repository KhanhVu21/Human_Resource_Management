...
public static class BusinessTripEmployeeSqlQueries
{
    ...
    public const string QueryGetAllBusinessTripEmployeeNotInIds = "select * from [dbo].[TicketLaborEquipmentDetail] where Id not in @Ids and IdBusinessTrip = @IdBusinessTrip";
